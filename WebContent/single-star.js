...
function handleResult(resultData) {
    ...
    let starNameElement = jQuery("#star_name_here");
    starNameElement.append("<h1>" + resultData[0]["star_name"] + "</h1>");
...
jQuery.ajax({
    ...
    url: "moviedb/single-star?id=" + starId, // Setting request url, which is mapped by StarsServlet in Stars.java
